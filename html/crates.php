...
<div class="header">
    ...
    <form action="crates.php" method="POST">
        <div class="input">
...
<div class="navMenu">
    <ul>
        ...
        <a href="crates.php" id="active"><li>Crates and Cages</li></a>
...
<?php 
    ...
    if (isset($_POST['search'])) {
        ...
        $sql = ("SELECT * FROM tbproduct WHERE name LIKE '%$searchq%' and category = 'crates'") or die();
    ...
    $sql = "SELECT * FROM tbproduct WHERE category = 'crates'";
    $result = $mysqli->query($sql);
        if ($result->num_rows > 0) {
            while($row = mysqli_fetch_array($result)){
    ?>
