...
<div class="navMenu">
    <ul>
        ...
        <a href="grooming.php" id="active"><li>Grooming</li></a>
...
<?php 
    ...
    if (isset($_POST['search'])) {
        ...
        $sql = ("SELECT * FROM tbproduct WHERE name LIKE '%$searchq%' and category = 'groom'") or die();
    ...
    $sql = "SELECT * FROM tbproduct WHERE category = 'groom'";
    $result = $mysqli->query($sql);
        if ($result->num_rows > 0) {
            while($row = mysqli_fetch_array($result)){
    ?>
